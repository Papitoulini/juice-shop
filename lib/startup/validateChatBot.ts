...
export const checkIntentWithFunctionHandlerExists = (trainingData: { data: Array<{ intent: string, answers: Array<{ action: string, handler: string }> }> }, intent: string, handler: string) => {
  let success = true
