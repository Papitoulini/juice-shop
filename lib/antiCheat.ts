...
const solves: Array<{ challenge: { challengeKey: string }, phase: string, timestamp: Date, cheatScore: number }> = [{ challenge: { challengeKey: '' }, phase: 'server start', timestamp: new Date(), cheatScore: 0 }] // seed with server start timestamp
