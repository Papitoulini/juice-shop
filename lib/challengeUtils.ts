...
export const solve = function (challenge: { solved: boolean, save: () => Promise<{ difficulty: number, key: string, name: string }> }, isRestore = false) {
...
export const sendNotification = function (challenge: { difficulty?: number | undefined, key: string, name: string, description?: string | undefined }, isRestore: boolean) {
