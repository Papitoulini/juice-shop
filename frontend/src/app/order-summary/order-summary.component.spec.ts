...
describe('OrderSummaryComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    deliveryService.getById.and.returnValue(of({
      price: 10
    }));
    ...
    TestBed.configureTestingModule({
      ...
      }]), HttpClientTestingModule, TranslateModule.forRoot(), BrowserAnimationsModule, ReactiveFormsModule, MatInputModule, MatCardModule, MatTableModule, MatButtonModule, MatButtonToggleModule, MatIconModule, MatTooltipModule, MatSnackBarModule],
      providers: [{
  ...
  it('should remove session details from session storage', () => {
    basketService.checkout.and.returnValue(of({
      orderConfirmationId: '1234123412341234'
    }));
