...
let activatedRoute: import('src/app-routing.module').ActivatedRoute;
let basketService: BasketService = new BasketService();
let addressService: AddressService = new AddressService();