...
describe('OrderCompletionComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    trackOrderService.find.and.returnValue(of({
      data: [{
        products: []
      }]
    }));
    ...
    TestBed.configureTestingModule({
      ...
      imports: [RouterTestingModule, HttpClientTestingModule, TranslateModule.forRoot(), BrowserAnimationsModule, MatTableModule, MatPaginatorModule, MatDialogModule, MatDividerModule, MatGridListModule, MatCardModule, MatIconModule, MatTooltipModule],
      providers: [{
        provide: TrackOrderService,
        useValue: trackOrderService
      }, {
  ...
  it('should derive twitter handle from twitter URL if configured', () => {
    ...
    configurationService.getApplicationConfiguration.and.returnValue(of({
      application: {
        social: {
          twitterUrl: 'https://twitter.com/bkimminich'
        }
      }
    }));
    component.ngOnInit();
