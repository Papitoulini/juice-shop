...
describe('ComplaintComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, ReactiveFormsModule, FileUploadModule, TranslateModule.forRoot(), BrowserAnimationsModule, MatCardModule, MatFormFieldModule, MatInputModule, MatButtonModule],
  ...
  it('should display support message with #id and reset complaint form on saving complaint', () => {
    ...
    component.save();
    expect(translateService.get).toHaveBeenCalledWith('CUSTOMER_SUPPORT_COMPLAINT_REPLY', {
      ref: 42
    });
  });
  it('should begin uploading file if it has been added on saving', fakeAsync(() => {
    component.uploader.queue[0] = new FileItem(component.uploader, new File([''], 'file.pdf', {
