...
describe('AddressCreateComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      imports: [RouterTestingModule, TranslateModule.forRoot(), HttpClientTestingModule, ReactiveFormsModule, BrowserAnimationsModule, MatCardModule, MatFormFieldModule, MatInputModule, MatGridListModule, MatIconModule, MatSnackBarModule],
  ...
  it('should clear the form and display error if saving address fails', fakeAsync(() => {
    addressService.save.and.returnValue(throwError({
      error: 'Error'
    }));
    spyOn(component, 'resetForm');
    component.save();
  ...
  it('should clear the form and display error if updating address fails', fakeAsync(() => {
    addressService.put.and.returnValue(throwError({
      error: 'Error'
    }));
    component.mode = 'edit';
    spyOn(component, 'resetForm');
