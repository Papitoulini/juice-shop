...
describe('AdministrationComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    userService.find.and.returnValue(of([{
      email: 'User1'
    }, {
      email: 'User2'
    }]));
    feedbackService = jasmine.createSpyObj('FeedbackService', ['find', 'del']);
    feedbackService.find.and.returnValue(of([{
      comment: 'Feedback1'
    }, {
      comment: 'Feedback2'
    }]));
    ...
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, MatTableModule, TranslateModule.forRoot(), MatDialogModule, MatPaginatorModule, MatDividerModule, MatCardModule, MatIconModule],
