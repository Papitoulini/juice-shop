...
describe('AccountingComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      ...
      imports: [RouterTestingModule, HttpClientTestingModule, TranslateModule.forRoot(), BrowserAnimationsModule, MatTableModule, MatPaginatorModule, MatFormFieldModule, MatDividerModule, MatGridListModule, MatCardModule, MatIconModule, MatTooltipModule, MatSnackBarModule],
      providers: [{
        provide: ProductService,
        useValue: productService
      }, {
        provide: QuantityService,
        useValue: quantityService
      }, {
        provide: OrderHistoryService,
        useValue: orderHistoryService
      }, {
        provide: MatSnackBar,
        useValue: snackBar
      }]
  ...
  it('should log and display errors while modifying price', fakeAsync(() => {
    productService.put.and.returnValue(throwError({
      error: 'Error'
    }));
    console.log = jasmine.createSpy('log');
  ...
  it('should log and display errors while modifying quantity', fakeAsync(() => {
    quantityService.put.and.returnValue(throwError({
      error: 'Error'
    }));
    console.log = jasmine.createSpy('log');
