...
const routes: Routes = [{
  ...
  path: 'administration',
  // vuln-code-snippet vuln-line adminSectionChallenge
...
// vuln-code-snippet neutral-line adminSectionChallenge
{
  ...
  path: 'score-board',
  // vuln-code-snippet vuln-line scoreBoardChallenge
...
// vuln-code-snippet neutral-line scoreBoardChallenge
{
  ...
  path: 'web3-sandbox',
  // vuln-code-snippet vuln-line web3SandboxChallenge
...
export function token2(...args: number[]) {
  // vuln-code-snippet neutral-line tokenSaleChallenge
  const T = Array.from(args); // vuln-code-snippet neutral-line tokenSaleChallenge
