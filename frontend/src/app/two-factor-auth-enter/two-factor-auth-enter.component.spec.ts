...
describe('TwoFactorAuthEnterComponent', () => {
  {
    ...
    beforeEach(waitForAsync(() => {
      ...
      TestBed.configureTestingModule({
        ...
        }]), ReactiveFormsModule, CookieModule.forRoot(), TranslateModule.forRoot(), BrowserAnimationsModule, MatCheckboxModule, MatFormFieldModule, MatCardModule, MatIconModule, MatInputModule, MatTableModule, MatPaginatorModule, MatDialogModule, MatDividerModule, MatButtonModule, MatGridListModule, MatSnackBarModule, MatTooltipModule],
        ...
        }, CookieService, WindowRefService, CookieService]
      }).compileComponents();
