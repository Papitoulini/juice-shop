  ...
  describe('difficultySummaries', () => {
    ...
    it('should calculate difficulty summaries', () => {
      expect(DifficultyOverviewScoreCardComponent.calculateDifficultySummaries([
        { difficulty: 1, solved: true, hasCodingChallenge: false } as { difficulty: number, solved: boolean, hasCodingChallenge: boolean },
        { difficulty: 1, solved: true, hasCodingChallenge: true, codingChallengeStatus: 1 } as { difficulty: number, solved: boolean, hasCodingChallenge: boolean, codingChallengeStatus: number }
      ])).toEqual([
    ...
    it('should calculate difficulty summaries for multiple difficulties', () => {
      expect(DifficultyOverviewScoreCardComponent.calculateDifficultySummaries([
        { difficulty: 1, solved: true, hasCodingChallenge: true, codingChallengeStatus: 0 } as { difficulty: number, solved: boolean, hasCodingChallenge: boolean, codingChallengeStatus: number },
        { difficulty: 1, solved: true, hasCodingChallenge: true, codingChallengeStatus: 0 } as { difficulty: number, solved: boolean, hasCodingChallenge: boolean, codingChallengeStatus: number },
        { difficulty: 1, solved: true, hasCodingChallenge: true, codingChallengeStatus: 1 } as { difficulty: number, solved: boolean, hasCodingChallenge: boolean, codingChallengeStatus: number },
        { difficulty: 1, solved: true, hasCodingChallenge: true, codingChallengeStatus: 2 } as { difficulty: number, solved: boolean, hasCodingChallenge: boolean, codingChallengeStatus: number },
        { difficulty: 1, solved: false, hasCodingChallenge: true, codingChallengeStatus: 0 } as { difficulty: number, solved: boolean, hasCodingChallenge: boolean, codingChallengeStatus: number },
        { difficulty: 2, solved: true, hasCodingChallenge: true, codingChallengeStatus: 0 } as { difficulty: number, solved: boolean, hasCodingChallenge: boolean, codingChallengeStatus: number },
        { difficulty: 3, solved: false, hasCodingChallenge: true, codingChallengeStatus: 0 } as { difficulty: number, solved: boolean, hasCodingChallenge: boolean, codingChallengeStatus: number }
      ])).toEqual([
