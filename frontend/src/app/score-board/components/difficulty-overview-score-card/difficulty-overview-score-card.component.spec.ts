...
it('should calculate difficulty summaries', () => {
          expect(DifficultyOverviewScoreCardComponent.calculateDifficultySummaries([
            { difficulty: 1, solved: true, hasCodingChallenge: false } as DifficultyOverview,
            { difficulty: 1, solved: true, hasCodingChallenge: true, codingChallengeStatus: 1 } as DifficultyOverview
          ])).toEqual([
...
it('should calculate difficulty summaries for multiple difficulties', () => {
          expect(DifficultyOverviewScoreCardComponent.calculateDifficultySummaries([
{ difficulty: 1, solved: true, hasCodingChallenge: true, codingChallengeStatus: 0 } as DifficultyOverview,
{ difficulty: 1, solved: true, hasCodingChallenge: true, codingChallengeStatus: 0 } as DifficultyOverview,
