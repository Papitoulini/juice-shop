...
describe('SearchResultComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    basketService.find.and.returnValue(of({
      Products: []
    }));
    ...
    basketService.save.and.returnValue(of({
      ProductId: 1
    }));
    ...
    TestBed.configureTestingModule({
      ...
      imports: [RouterTestingModule, HttpClientTestingModule, TranslateModule.forRoot(), BrowserAnimationsModule, MatTableModule, MatPaginatorModule, MatDialogModule, MatDividerModule, MatGridListModule, MatCardModule],
      providers: [{
  ...
  it('should add similar product to basket', () => {
    ...
    expect(productService.get).toHaveBeenCalled();
    expect(translateService.get).toHaveBeenCalledWith('BASKET_ADD_SAME_PRODUCT', {
