...
describe('ChatbotService', () => {
  ...
  it('should get status from the REST API', inject([ChatbotService, HttpTestingController], fakeAsync((service: ChatbotService, httpMock: HttpTestingController) => {
    {
      let res: {
        status: boolean;
        body: string;
  ...
  it('should get query response from the REST API', inject([ChatbotService, HttpTestingController], fakeAsync((service: ChatbotService, httpMock: HttpTestingController) => {
    {
      let res: {
        action: string;
        body: string;
