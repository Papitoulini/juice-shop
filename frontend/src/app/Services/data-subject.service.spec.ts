...
describe('DataSubjectService', () => {
  ...
  it('should pass the erasure request directly to the rest API', inject([DataSubjectService, HttpTestingController], fakeAsync((service: DataSubjectService, httpMock: HttpTestingController) => {
    {
      let res: string;
  ...
  it('should request data export directly from the rest api', inject([DataSubjectService, HttpTestingController], fakeAsync((service: DataSubjectService, httpMock: HttpTestingController) => {
    {
      let res: string;
