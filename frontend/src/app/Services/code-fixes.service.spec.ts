...
describe('CodeFixesService', () => {
  ...
  it('should get code fixes for challenge directly from the rest api', inject([CodeFixesService, HttpTestingController], fakeAsync((service: CodeFixesService, httpMock: HttpTestingController) => {
    {
      let res: {
        snippet: string;
      };
  ...
  it('should submit solution for "Fit It" phase of coding challenge via the rest api', inject([CodeFixesService, HttpTestingController], fakeAsync((service: CodeFixesService, httpMock: HttpTestingController) => {
    {
      let res: string;
