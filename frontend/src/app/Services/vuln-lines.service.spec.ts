...
describe('VulnLinesService', () => {
  ...
  it('should submit solution for "Fit It" phase of coding challenge via the rest api', inject([VulnLinesService, HttpTestingController], fakeAsync((service: VulnLinesService, httpMock: HttpTestingController) => {
    {
      let res: string;
