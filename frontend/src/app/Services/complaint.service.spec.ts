...
describe('ComplaintService', () => {
  ...
  it('should create complaint directly via the rest api', inject([ComplaintService, HttpTestingController], fakeAsync((service: ComplaintService, httpMock: HttpTestingController) => {
    {
      let res: string;
