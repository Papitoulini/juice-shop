...
describe('BasketComponent', () => {
  {
    ...
    beforeEach(waitForAsync(() => {
      TestBed.configureTestingModule({
        ...
        imports: [RouterTestingModule, HttpClientTestingModule, TranslateModule.forRoot(), BrowserAnimationsModule, ReactiveFormsModule, MatFormFieldModule, MatInputModule, MatCardModule, MatTableModule, MatButtonModule, MatExpansionModule, MatDialogModule, MatButtonToggleModule, MatSnackBarModule],
        providers: [{
          provide: DeluxeGuard,
