...
describe('ChallengeSolvedNotificationComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, TranslateModule.forRoot(), CookieModule.forRoot(), ClipboardModule, MatCardModule, MatButtonModule, MatIconModule],
  ...
  it('should store retrieved continue code as cookie for 1 year', () => {
    ...
    expect(cookieService.put).toHaveBeenCalledWith('continueCode', '12345', {
      expires
    });
  });
