...
describe('ContactComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      imports: [TranslateModule.forRoot(), HttpClientTestingModule, ReactiveFormsModule, MatSliderModule, BrowserAnimationsModule, MatCardModule, MatFormFieldModule, MatInputModule, MatSnackBarModule],
  ...
  it('should clear the form display error if saving feedback fails', fakeAsync(() => {
    feedbackService.save.and.returnValue(throwError({
      error: 'Error'
    }));
