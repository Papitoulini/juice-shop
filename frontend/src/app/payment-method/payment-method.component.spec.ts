...
describe('PaymentMethodComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      imports: [TranslateModule.forRoot(), HttpClientTestingModule, ReactiveFormsModule, BrowserAnimationsModule, MatCardModule, MatTableModule, MatFormFieldModule, MatInputModule, MatExpansionModule, MatDividerModule, MatRadioModule, MatDialogModule],
  ...
  it('should clear the form and display error if saving card fails', fakeAsync(() => {
    paymentService.save.and.returnValue(throwError({
      error: 'Error'
    }));
    spyOn(component, 'resetForm');
    component.save();
