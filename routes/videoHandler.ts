...
const subs = getSubsFromFile()
      ...
      challengeUtils.solveIf(challenges.videoXssChallenge, () => { return utils.contains(DOMPurify.sanitize(subs), '</script><script>alert(`xss`)</script>') })
...
const fn = pug.compile(template)
      ...
      compiledTemplate = compiledTemplate.replace('<script id="subtitle"></script>', '<script id="subtitle" type="text/vtt" data-label="English" data-lang="en">' + pug.escape(subs) + '</script>')
